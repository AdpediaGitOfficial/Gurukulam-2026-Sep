...
const ICONS = {
  ...
  "nav-batches": { src: "/icons/nav-batches.svg", width: 20, height: 20 },
  "nav-fee-ledger": { src: "/icons/nav-fee-ledger.svg", width: 20, height: 20 },
  "nav-hiring": { src: "/icons/nav-hiring.svg", width: 20, height: 20 },
  "nav-reports": { src: "/icons/nav-reports.svg", width: 20, height: 20 },
